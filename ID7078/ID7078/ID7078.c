...
void Game1()
{
    ...
    else if(CSLeft_R>=240 && CSLeft_G>=92 && CSLeft_G<=122 && CSLeft_B<=15 && CSRight_R>=240 && CSRight_G>=92 && CSRight_G<=122 && CSRight_B<=15 && Time<=32900&&(LoadedObjects>2))
    {
        Duration = 75;
        CurAction =2;
    }
    else if(CSLeft_R>=240 && CSLeft_G>=92 && CSLeft_G<=122 && CSLeft_B<=15 && CSRight_R>=240 && CSRight_G>=92 && CSRight_G<=122 && CSRight_B<=15 && Time>=33000&&(LoadedObjects>0))
    {
        Duration = 75;
        CurAction =3;
    }
    else if(CSLeft_R>=240 && CSLeft_G>=92 && CSLeft_G<=122 && CSLeft_B<=15&&(LoadedObjects>2))
    {
        Duration = 0;
        CurAction =4;
    }
    else if(CSRight_R>=240 && CSRight_G>=92 && CSRight_G<=122 && CSRight_B<=15&&(LoadedObjects>2))
    {
        Duration = 0;
        CurAction =5;
    }
    ...
    else if(PositionX>=345 && PositionX<=360 && PositionY>=1 && Compass>=261 && Compass<=279)
    {
        Duration = 7;
        CurAction =13;
    }
    ...
    else if(PositionX>=146 && PositionX<=217 && PositionY>=78 && PositionY<=117&&(gotoTarget==1))
    {
        Duration = 0;
        CurAction =29;
    }
